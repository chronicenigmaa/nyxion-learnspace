...
export default function FeedbackPage() {
  ...
  return (
    <div className="max-w-3xl">
      <h1 className="text-2xl font-bold text-[var(--text-primary)] mb-1">Feedback Writer</h1>
      <p className="text-[var(--text-secondary)] text-sm mb-6">Generate personalised student feedback based on their submission and marks</p>
      <div className="p-5 rounded-xl border border-[var(--border)] mb-4" style={{ background: 'var(--surface-850)' }}>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
          ...
          <div>
            <label className="block text-sm text-[var(--text-secondary)] mb-1">Assignment Title (optional)</label>
          ...
          <div>
            <label className="block text-sm text-[var(--text-secondary)] mb-1">Marks Obtained</label>
          ...
          <div>
            <label className="block text-sm text-[var(--text-secondary)] mb-1">Max Marks</label>
          ...
          <div className="md:col-span-2">
            <label className="block text-sm text-[var(--text-secondary)] mb-1">Student Submission</label>
      ...
      {result && (
        <div className="p-5 rounded-xl border border-[var(--border)]" style={{ background: 'var(--surface-850)' }}>
          <div className="flex justify-between items-center mb-3">
            <h2 className="text-[var(--text-primary)] font-medium">Generated Feedback</h2>
