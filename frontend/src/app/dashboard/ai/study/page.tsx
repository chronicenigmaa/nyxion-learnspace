...
export default function StudentAIPage() {
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-[var(--text-primary)] mb-1">AI Study Tools</h1>
        ...
        {tools.map(tool => {
          ...
          return (
            <Link key={tool.href} href={tool.href}
              ...
              <div className="text-[var(--text-primary)] font-medium mb-1 group-hover:text-indigo-600 transition-colors">{tool.label}</div>
