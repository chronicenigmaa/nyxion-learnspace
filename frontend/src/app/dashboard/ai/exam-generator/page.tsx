...
export default function ExamGeneratorPage() {
  ...
  return (
    <div className="max-w-3xl">
      <h1 className="text-2xl font-bold text-[var(--text-primary)] mb-1">Exam Generator</h1>
      <p className="text-[var(--text-secondary)] text-sm mb-6">Generate exam questions for any subject and topic</p>
      ...
      <div className="p-5 rounded-xl border border-[var(--border)] mb-4" style={{ background: 'var(--surface-850)' }}>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
          ...
          <div>
            <label className="block text-sm text-[var(--text-secondary)] mb-1">Number of Questions</label>
          ...
          <div>
            <label className="block text-sm text-[var(--text-secondary)] mb-1">Difficulty</label>
          ...
          <div>
            <label className="block text-sm text-[var(--text-secondary)] mb-1">Question Type</label>
      ...
      {result && (
        <div className="p-5 rounded-xl border border-[var(--border)]" style={{ background: 'var(--surface-850)' }}>
          <div className="flex justify-between items-center mb-3">
            <h2 className="text-[var(--text-primary)] font-medium">Generated Exam</h2>
