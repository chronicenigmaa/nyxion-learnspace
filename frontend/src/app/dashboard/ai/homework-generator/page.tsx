...
export default function HomeworkGeneratorPage() {
  ...
  return (
    <div className="max-w-3xl">
      <h1 className="text-2xl font-bold text-[var(--text-primary)] mb-1">Homework Generator</h1>
      <p className="text-[var(--text-secondary)] text-sm mb-6">Create homework assignments with answer keys</p>
      ...
      {result && (
        <div className="p-5 rounded-xl border border-[var(--border)]" style={{ background: 'var(--surface-850)' }}>
          <div className="flex justify-between items-center mb-3">
            <h2 className="text-[var(--text-primary)] font-medium">Generated Homework</h2>
