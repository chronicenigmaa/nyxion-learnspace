...
export default function LessonPlannerPage() {
  ...
  return (
    <div className="max-w-3xl">
      <h1 className="text-2xl font-bold text-[var(--text-primary)] mb-1">Lesson Planner</h1>
      <p className="text-[var(--text-secondary)] text-sm mb-6">Build structured lesson plans with objectives and activities</p>
      <div className="p-5 rounded-xl border border-[var(--border)] mb-4" style={{ background: 'var(--surface-850)' }}>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
          ...
          <div>
            <label className="block text-sm text-[var(--text-secondary)] mb-1">Duration (minutes)</label>
          ...
          <div className="md:col-span-2">
            <label className="block text-sm text-[var(--text-secondary)] mb-1">Learning Objectives (optional)</label>
      ...
      {result && (
        <div className="p-5 rounded-xl border border-[var(--border)]" style={{ background: 'var(--surface-850)' }}>
          <div className="flex justify-between items-center mb-3">
            <h2 className="text-[var(--text-primary)] font-medium">Lesson Plan</h2>
