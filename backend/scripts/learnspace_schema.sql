...
--
-- Every account below has the password:  Nyxion@123
--
...
VALUES
    ('04e673be-3cba-40c6-9bfb-676e207d79d2'::uuid, 'Super Admin', 'superadmin@nyxion.test', '$2b$12$KDr5U8PW4ZtK/0pFiI0Ib.kLkY1m4X0sx90BDinQt43T9ICjRixUK', 'super_admin', NULL, NULL, NULL, NULL, '#4f46e5', true, now()),
    ('09d7954c-c58f-4d1a-a987-739738905546'::uuid, 'School Admin', 'schooladmin@nyxion.test', '$2b$12$q/3aal2MsB1D4WEzUOO4PuM8llSubUjaP7aBVdQogtgZmoW/LdqGm', 'school_admin', 'SCH-001', NULL, NULL, NULL, '#d97706', true, now()),
    ('005f3430-b088-4636-ae60-25d2de66fc7b'::uuid, 'Fatima Malik', 'fatima@nyxion.test', '$2b$12$ikqyJjLDUjdo6axb/tlJrOAfC78Quzx9Tc.oCmT80hJ8DGNIDXOZC', 'teacher', 'SCH-001', 'Mathematics', NULL, NULL, '#4f46e5', true, now()),
    ('f66712c2-33ff-42e5-9083-12d080e2103a'::uuid, 'Usman Tariq', 'usman@nyxion.test', '$2b$12$Tt.bqfl8ybWjRQsO6W.GI.36YKr/vX5F.mZTOeDRSUb8.dplZ5d/C', 'teacher', 'SCH-001', 'Physics', NULL, NULL, '#0891b2', true, now()),
    ('035ff6f1-bcc8-47a5-87bc-09e526f47b2a'::uuid, 'Ayesha Siddiqui', 'ayesha@nyxion.test', '$2b$12$EJMShQAUCBAZSfASh3Cj1.CrYho8WLisTkPqc.ke52mmzqBfN9Vqq', 'teacher', 'SCH-001', 'English', NULL, NULL, '#7c3aed', true, now()),
    ('7ad41ca2-7064-4160-b55f-42e8c5fd2f0b'::uuid, 'Ahmed Khan', 'ahmed@nyxion.test', '$2b$12$RSCTu/VS.0AJgrKCyNyBrOb34/K8Bia1ARp8C/Aa01bLKz/sCNnCS', 'student', 'SCH-001', NULL, 'Class 9A', '09A-001', '#059669', true, now()),
    ('7f0db80c-8ba8-4015-b93d-da5e02c228e7'::uuid, 'Sara Malik', 'sara@nyxion.test', '$2b$12$Sp.o0rkrhfgRctcTXCb22./ENFGvCPlsuM7//VaejK/xBomMQNBqi', 'student', 'SCH-001', NULL, 'Class 9A', '09A-002', '#059669', true, now()),
    ('5fa258e5-1191-4461-aae8-b83717b9d08a'::uuid, 'Imran Butt', 'imran@nyxion.test', '$2b$12$ZA1Do7k55OwQCwTYZ8HEHeow.PK9MqGjcTHi1J86rSJ/vyBrri8ca', 'student', 'SCH-001', NULL, 'Class 10A', '10A-001', '#059669', true, now()),
    ('20ba60c5-99eb-4253-9754-87453b9f6b40'::uuid, 'Rabia Noor', 'rabia@nyxion.test', '$2b$12$QBF8dnd06R6ddUkbipDddu.iUWs5g1AgqHPpSVvSNG/Nwn299WHSi', 'student', 'SCH-001', NULL, 'Class 10A', '10A-002', '#059669', true, now()),
    ('f017aa31-faf6-400e-a02b-41ba7e35ebc9'::uuid, 'Parent of Ahmed', 'parent1@nyxion.test', '$2b$12$5NzIVBP4jzy5P7ye8Ud.iuEMR36jXnOcSXBKkliKJcQsR2tIz0Pzu', 'parent', 'SCH-001', NULL, NULL, NULL, '#db2777', true, now()),
    ('47d7e572-2458-4d2b-a18f-19896ed37ff2'::uuid, 'Parent of Imran', 'parent2@nyxion.test', '$2b$12$aCpt6cKqv3RKyfD3KYe/yurvmSz/ZyWuDIdZMqFNYyPkzXImVkU6.', 'parent', 'SCH-001', NULL, NULL, NULL, '#db2777', true, now())
